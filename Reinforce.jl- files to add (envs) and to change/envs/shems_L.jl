...
ShemsState() = ShemsState(0f0, 22f0, 180f0, 0f0, 0f0, 0f0, 0f0, 0f0, 0f0, 1f0, 0f0, 1f0, 0f0) #, 0f0)
...
function action(env::Shems, track=-1)
	if track == -1
		Soc_b, T_fh, V_hw, d_e, d_fh, d_hw, g_e, t_out, p_buy, h_cos, h_sin, season, d_res = env.state
		################### Heat pump ########################################
		# HP percentage SOCs
