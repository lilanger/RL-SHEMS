...
#------------ local machine ----------
Job_ID=1845745
Task_ID = 1845745-1 #ENV["SGE_TASK_ID"]
seed_run = 40 # run inference over all seeds 
#--------cluster jobs------------
# Job_ID = ENV["JOB_ID"]
...
plot_all = 0
render = 0
track = 1  # 0 - off, 1 - DRL, rule-based percentage of start Soc e.g. 70% -> -0.7
...
using Reinforce.ShemsEnv_H10: Shems
case = "$(season)_$(algo)_$(price)_base-256_gn.1_Env-H10-no-layer-norm-winter"
run = "test"
NUM_EP = 3_001 #50_000
L1 = 300 #256
L2 = 600 #256
