...
#------------ local machine ----------
Job_ID=1149871
Task_ID = 1149871-1 #ENV["SGE_TASK_ID"]
...
plot_all = 1
render = 0
track = 0  # 0 - off, 1 - DRL, -1 - rule-based 1, -2 rule-based 2
...
using Reinforce.ShemsEnv_U6: Shems
case = "$(season)_$(algo)_$(price)_fudji-yu_gn.1_M-full-20T_Env-U6"
run = "eval"
NUM_EP = 3_001 #50_000
L1 = 256
L2 = 256
