...
season = "summer" # "all" "both" "summer" "winter"
algo="DDPG"
price= "fix" # "fix", "TOU"
noise_type = "gn" # "ou", "pn", "gn", "en"

using Reinforce.ShemsEnv_U3: Shems
case = "$(season)_$(algo)_$(price)_fudji-yu_gn.1_M-full-20T_Env-U3"
run = "eval"
NUM_EP = 3_001 #50_000
L1 = 256
L2 = 256
...
WAIT = Dict(
          ...
          ("winter", "DDPG") => 1500, ("winter", "TD3") => 1500, ("winter", "SAC") => 5000,
