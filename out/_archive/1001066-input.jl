...
τ_ = 25
ϵ  = exp(-1f0 / τ_)
noise_scale = 1f0 ./ ACTION_BOUND_HI |> gpu #note needed because scaling happens afterwards then 1:1

# Fill struct with values
ou = OUNoise(μ, θ, σ, dt, zeros(Float32, ACTION_SIZE) |> gpu)
